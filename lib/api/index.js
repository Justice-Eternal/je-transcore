  ...
  _createClass(Transcore, null, [{
    ...
    value: function tune(source) {
      ...
      if (options.mode === 'JE') {
        ...
        var _tokens = (0, _lexer2.default)(source);
        var result = '';
        (0, _Note.withOptions)({ preferSharpB: options.preferSharpB })(function () {
          result = (0, _renderer2.default)(_tokens, new _visitor2.default({ nameTable: names }), [new _TunePlugin2.default(options)]);
        })();
        return result;
      }

      var tokens = (0, _lexer.bdLex)(source);
      return (0, _renderer2.default)(tokens, new _visitor.BDVisitor(options), [new _TunePlugin2.default(options)]);
    }
  }, {
    key: 'toBD',
    value: function toBD(jeSource) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      ...
      var tokens = (0, _lexer2.default)(jeSource);
      return (0, _renderer2.default)(tokens, new _visitor.BDVisitor(options));
    }
  }, {
    key: 'toJE',
    value: function toJE(bdSource, options) {
      options = Object.assign({
        offset: 0,
        preferSharpE: false,
        preferSharpB: false
      ...
      var tokens = (0, _lexer.bdLex)(bdSource);
      var result = '';
      (0, _Note.withOptions)({ preferSharpB: options.preferSharpB })(function () {
